...
protected:
  ...
  // enable IMDSv2 — unset so provider resolves: C++ default false (no token PUT);
  // true when setEnableIMDSv2(true) / ALIBABA_CLOUD_ECS_IMDSV2_ENABLE=true / disableIMDSv1
