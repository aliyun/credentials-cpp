...
namespace Models {
  ...
  public:
    ...
    const Darabonba::IStream &deserializedBody() const {
      DARABONBA_PTR_GET(deserializedBody_);
    }

    std::shared_ptr<Darabonba::IStream> &deserializedBody() { DARABONBA_GET(deserializedBody_); }
...
//    }
//
//    InterceptorContextResponse &setDeserializedBody(
...
//    }
  ...
  protected:
    ...
    std::shared_ptr<Darabonba::IStream> deserializedBody_ = nullptr;
    std::shared_ptr<Darabonba::Http::Header> headers_ = nullptr;
  ...
  public:
    ...
    InterceptorContextConfiguration &configuration() { DARABONBA_PTR_GET(configuration_); }
    ...
    const InterceptorContextRequest &request() const { DARABONBA_PTR_GET(request_); }

    InterceptorContextRequest &request() { DARABONBA_PTR_GET(request_); }
    ...
    const InterceptorContextResponse &response() const { DARABONBA_PTR_GET(response_); }

    InterceptorContextResponse &response() { DARABONBA_PTR_GET(response_); }
