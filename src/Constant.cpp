...
const std::string Constant::ENV_VPC_ENDPOINT_ENABLED = "ALIBABA_CLOUD_VPC_ENDPOINT_ENABLED";
const std::string Constant::ENV_CLI_PROFILE_DISABLED = "ALIBABA_CLOUD_CLI_PROFILE_DISABLED";

// OIDC Environment Variables
const std::string Constant::ENV_ROLE_ARN = "ALIBABA_CLOUD_ROLE_ARN";
const std::string Constant::ENV_OIDC_PROVIDER_ARN = "ALIBABA_CLOUD_OIDC_PROVIDER_ARN";
const std::string Constant::ENV_OIDC_TOKEN_FILE = "ALIBABA_CLOUD_OIDC_TOKEN_FILE";
const std::string Constant::ENV_ROLE_SESSION_NAME = "ALIBABA_CLOUD_ROLE_SESSION_NAME";
...
const std::string Constant::ENV_OAUTH_CLIENT_SECRET = "ALIBABA_CLOUD_CLIENT_SECRET";
const std::string Constant::ENV_OAUTH_TOKEN_ENDPOINT = "ALIBABA_CLOUD_OAUTH_TOKEN_ENDPOINT";
} // namespace Credential
} // namespace AlibabaCloud
