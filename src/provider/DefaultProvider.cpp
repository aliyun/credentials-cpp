...
namespace Credential {
 ...
 DefaultProvider::DefaultProvider() {
   ...
   auto ecsMetadataDisabled = Darabonba::Env::getEnv("ALIBABA_CLOUD_ECS_METADATA_DISABLED");
   if (ecsMetadataDisabled != "true" && ecsMetadataDisabled != "True" && ecsMetadataDisabled != "TRUE") {
